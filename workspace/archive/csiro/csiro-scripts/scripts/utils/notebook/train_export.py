...
#
# Provides utilities for detecting train/export mode and auto-detecting grid search results

import logging
from typing import Optional
from pathlib import Path

from .core import print_config_section
from .grid_search.utils import auto_detect_grid_search_results
...
def detect_train_export_mode(
    ...
    Returns:
        Path to grid search results file (string)
    ...
    try:
        results_file = auto_detect_grid_search_results(dataset_type, model_name=model_name)
