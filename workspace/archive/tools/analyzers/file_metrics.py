...
from core import file_utils, module_utils, ast_utils
        ...
        for file_path in files:
            ...
            if tree:
                ...
                for func_name, func_node in ast_utils.get_all_functions(tree):
                    func_lines = ast_utils.count_lines_in_node(func_node)
                    if func_lines > 50:
...
import ast  # Import here to avoid circular dependency
