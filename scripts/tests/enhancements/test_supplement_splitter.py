...
def test_supplement_splitter_initialization():
...
def test_supplement_splitter_with_input_data(tmp_path, mocker):
...
def test_supplement_splitter_missing_supplement():
