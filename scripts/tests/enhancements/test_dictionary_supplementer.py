...
def test_dictionary_supplementer_initialization():
...
def test_dictionary_supplementer_with_input_data(tmp_path, mocker):
...
def test_dictionary_supplementer_missing_supplements(tmp_path, mocker):
...
def test_dictionary_supplementer_specific_domains(tmp_path, mocker):
...
def test_dictionary_supplementer_update_existing(tmp_path, mocker):
