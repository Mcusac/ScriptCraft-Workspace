...
from scripts.checkers.dictionary_driven_checker import checker as dict_checker
from scripts.checkers.feature_change_checker import checker as feature_checker
...
def test_dictionary_checker_performance(sample_paths, temp_output_dir):
...
@pytest.mark.performance
def test_feature_checker_performance(sample_paths, temp_output_dir):
