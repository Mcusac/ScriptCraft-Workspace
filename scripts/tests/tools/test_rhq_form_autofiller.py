...
from scripts.tools.rhq_form_autofiller.main import RHQFormAutofiller
...
def test_tool_run_with_valid_input(mock_chrome, tool, sample_excel_file, temp_dir, mock_webdriver):
...
def test_tool_run_with_nonexistent_file(tool, temp_dir):
...
@patch('scripts.tools.rhq_form_autofiller.utils.webdriver.Chrome')
def test_tool_cleanup_on_error(mock_chrome, tool, sample_excel_file, temp_dir, mock_webdriver):
...
@patch('scripts.tools.rhq_form_autofiller.utils.webdriver.Chrome')
def test_tool_med_id_filtering(mock_chrome, tool, sample_excel_file, temp_dir, mock_webdriver):
