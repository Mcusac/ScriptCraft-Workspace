...
def test_tool_run_with_valid_input(tool, sample_excel_file, sample_docx_template, temp_dir):
...
def test_tool_run_without_input(tool):
...
def test_tool_run_with_missing_excel(tool, sample_docx_template, temp_dir):
...
def test_tool_run_with_missing_template(tool, sample_excel_file, temp_dir):
...
def test_tool_output_content(tool, sample_excel_file, sample_docx_template, temp_dir):
...
def test_tool_chunk_processing(tool, sample_excel_file, sample_docx_template, temp_dir):
...
def test_tool_output_directory_creation(tool, sample_excel_file, sample_docx_template, temp_dir):
...
def test_tool_empty_excel_handling(tool, temp_dir, sample_docx_template):
