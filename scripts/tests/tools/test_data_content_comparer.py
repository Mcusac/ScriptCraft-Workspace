...
def test_tool_run_without_mode(tool, sample_comparison_files):
...
def test_tool_run_with_invalid_mode(tool, sample_comparison_files):
...
def test_tool_run_without_input_files(tool):
...
def test_tool_run_with_valid_input(mock_load_mode, tool, sample_comparison_files, temp_dir):
...
@patch('scripts.tools.data_content_comparer.utils.load_mode')
def test_tool_standard_mode_comparison(mock_load_mode, tool, temp_dir):
...
@patch('scripts.tools.data_content_comparer.utils.load_mode')
def test_tool_rhq_mode_comparison(mock_load_mode, tool, sample_excel_file, temp_dir):
...
def test_tool_output_directory_creation(tool, sample_comparison_files):
...
@patch('scripts.tools.data_content_comparer.utils.load_mode')
def test_tool_domain_handling(mock_load_mode, tool, sample_comparison_files, temp_dir):
