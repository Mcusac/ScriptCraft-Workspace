"""Tests for the Pipeline Steps module."""

import pytest
from unittest.mock import Mock, patch

from scripts.pipelines.pipeline_steps import (
    import_function,
    build_step,
    PipelineFactory,
    get_pipeline_steps
)
from scripts.pipelines.base_pipeline import PipelineStep, BasePipeline


def test_import_function():
    """Test dynamic function importing."""
    # Test importing a real function
    func = import_function("scripts.common.get_project_root")
