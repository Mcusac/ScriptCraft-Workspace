"""Tests for the Base Pipeline class."""
...
def test_pipeline_step_validation():
    ...
    with patch('scripts.common.log_and_print') as mock_log:
...
def test_pipeline_step_management():
...
def test_pipeline_execution(tmp_path):
    ...
    with patch('scripts.common.get_domain_paths', return_value=mock_paths):
        # Test domain mode
...
def test_pipeline_error_handling(caplog):
