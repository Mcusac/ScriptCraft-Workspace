...
import pandas as pd
import pytest
from scripts.validators.medvisit_integrity_validator.main import run_medvisit_integrity_validator
...
def test_medvisit_integrity_validator(temp_files):
...
def test_medvisit_integrity_validator_no_mapping():
...
def test_medvisit_integrity_validator_identical_data(temp_files):
